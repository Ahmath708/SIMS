...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?= base_url()?>/assests/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>EA</b>3140</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input type="hidden" name="login" id="login" value="453709346240" />
                    </div>
                    <!-- /.col -->
                </div>
            </form>
...
<!-- jQuery -->
<script src="<?= base_url()?>/assests/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
